...
def _metadata(version: str, requires_python: str) -> bytes:
    body = (
        ...
        "Project-URL: Homepage, https://github.com/statecrafting/tenant-tail\n"
        "Project-URL: Repository, https://github.com/statecrafting/tenant-tail\n"
        "Project-URL: Issues, https://github.com/statecrafting/tenant-tail/issues\n"
        ...
        "directly. See https://github.com/statecrafting/tenant-tail#readme.\n"
    )
