...
**Good vs bad:**
- BAD: `refactor: extract helper for hash comparison`
- GOOD: `fix: corpus binding mismatch now names both hashes`
- BAD: `feat: add new arg to verify-certificate`
- GOOD: `feat(cert): check the corpus binding by reference (spec 218)`
...
- No em dash character (U+2014) anywhere in the message. Use a colon, a
  comma, parentheses, or two sentences. This is house style (a hook also
  blocks U+2014 in file writes, but cannot police commit text).
